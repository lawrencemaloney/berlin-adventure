    ...
    <>
      ...
      <div className="page-std ">
        ...
        <p className="mx-[20px] mt-[1rem] max-w-[38ch] text-[20px] leading-[32px] mobile:max-w-[40ch] mobile:text-[25px]  laptop:max-w-[60ch]">
          ...
          (Rhein-Main-Flughafen in those days) to an Army headquarters building
          in downtown Frankfurt. I was traveling alone, so I think I must have
          taken a taxi. I remember being driven through the castle-like stone
          gates of the headquarters building and into the courtyard. It looked
          very much like (and may have been) the building pictured on the left.
      ...
      <p className="mx-[20px] mt-[1rem] max-w-[38ch] text-[20px] leading-[32px] mobile:max-w-[40ch] mobile:text-[25px]  laptop:max-w-[60ch]">
        ...
        Barracks being inter by Sargent First Class Ed LeClair who was in charge
        of assigning personnel within the 2nd Battalion, 6th Infantry, Berlin
        Brigade. Sgt. LeClair was calm and reasonable (an unexpected experience
        based upon my dealings with sergeants heretofore).
      </p>
