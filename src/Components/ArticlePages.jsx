      ...
      <div className=" z-20 mx-auto max-w-2xl flex h-[100%] flex-col items-center ">
        <div className="article-intro">
          ...
          <p className=" mx-auto my-3 p-1 w-[calc(100%-3em)] max-w-[35em] font-normal text-[1.4375rem]">
            ...
            issue. You can also access the full edition by clicking the "Full
            Edition PDF" button at the bottom of each article page.
          </p>
          <p className=" mx-auto my-3 p-1 w-[calc(100%-3em)] max-w-[35em] font-normal text-[1.4375rem]">
            ...
            have downloaded each issue, which can be accessed from the Archive
            page.
          </p>
